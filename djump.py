...
def dense():
    global cap,currentframe,denserunflag,denseframe
...
def left():
    ...
    if denseflag==1 and denserunflag == 1:
        if(high!=0):
...
add_checkbox(lble = 'optical flow',vble = denseflag ,ROW=4,COLUMN=3)

button.append(add_button("  left   ",left,4,2))
button.append(add_button("  right  ",right,4,4))

button.append(add_button("  annotate   ",flow_annotate,5,2))
button.append(add_button("  reject  ",reject,5,4))
